...
namespace PalasProject.UnitTests
{
    ...
    public class ParkingLotControllerShould
    {
        ...
        {
            // you could have mock the repository in a OneTimeSetup method, this is used in both methods
            // you did not respect Arrange/Act/Assert 
            //it is hard to read this test
